...
[![Publish Web Demo](https://github.com/baobabitogether-a11y/youtubenet3/actions/workflows/deploy-demo.yml/badge.svg)](https://github.com/baobabitogether-a11y/youtubenet3/actions/workflows/deploy-demo.yml)
...
```bash
curl -fsSL https://raw.githubusercontent.com/baobabitogether-a11y/youtubenet3/main/update.apk.sh | bash -s -- "https://github.com/baobabitogether-a11y/youtubenet3/releases/latest/download/YouTube-Viewer-debug.apk"
```
...
| :--- | :--- | :--- |
| 🚀 **Web-App Demo Landing Page** | [**Open Live Web Demo**](https://baobabitogether-a11y.github.io/youtubenet3/app/) | Standalone browser build with responsive playback controls, dual-language subtitles (`top`/`above`/`under`/`bottom`), and instant target language switching. |
| ⚡ **E2E Tests on Web (Cypress Runner)** | [**Open Cypress Runner**](https://baobabitogether-a11y.github.io/youtubenet3/) | Interactive web test runner with DOM time-travel step inspection, pinned snapshots, video player with chapter markers, and test filters. |
| 📱 **E2E Tests on Android Emulator** | [**Open Android Emulator Report**](https://baobabitogether-a11y.github.io/youtubenet3/android-emulator-report.html) | Standalone report verifying native WebView `shouldInterceptRequest` on Google Pixel 7 (Android 14 / API 34), Logcat audit, and hardware TTS loop verification. |
...
| 🔍 **Playwright Trace Inspector** | [**Open Playwright Trace**](https://baobabitogether-a11y.github.io/youtubenet3/playwright/index.html) | Network timeline, console events, and action waterfall inspector for web test execution. |
